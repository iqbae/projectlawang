...
if (isset($_POST['submit'])) {
    ...
    if (empty($err)) {
        ...
        for ($i = 1; $i < count($sheetData); $i++) {
            ...
            $sql1 = "INSERT INTO lawangkota(nomor, urusan, kd_skpd, kd_prog_keg, ur_prog_keg, op_ang, op_real, m_ang, m_real, tt_ang, tt_real, tf_ang, tf_real) VALUES ('$no', '$urusan', '$kd_skpd', '$kd_prog_keg', '$ur_prog_keg', '$op_ang', '$op_real', '$m_ang', '$m_real', '$tt_ang', '$tt_real', '$tf_ang', '$tf_real')";
